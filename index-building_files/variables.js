...
* @type {string}
*/
var ss_form_element = 'suggestion_form'; // search form  *IMPORTANT: make sure the form in the calling page has the same name as this value
